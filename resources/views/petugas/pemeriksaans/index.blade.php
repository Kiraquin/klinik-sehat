...
<div class="container">
    ...
    <form action="{{ route('petugas.pemeriksaans.store') }}" method="POST">
        @csrf
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <form action="{{ route('petugas.pemeriksaans.update', $pemeriksaan->id) }}" method="POST" style="display: inline;">
                        @csrf
                        @method('PUT')
                    ...
                    <form action="{{ route('petugas.pemeriksaans.destroy', $pemeriksaan->id) }}" method="POST" style="display: inline;">
                        @csrf
                        @method('DELETE')
